  ...
  <footer class="mt-16 bg-gradient-to-br from-[#0f1f4a] via-[#1a2d5a] to-[#0f1f4a] text-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <div class="grid grid-cols-1 gap-y-8 gap-x-12 sm:grid-cols-2 lg:grid-cols-4 mb-12">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2.5">
            <li>
              <button @click="handleBerandaClick" class="group inline-flex items-center gap-2 text-sm text-blue-100/80 hover:text-white transition-all duration-200">
                <span class="relative">
                  Beranda
            ...
            <li>
              <button @click="handleStadionClick" class="group inline-flex items-center gap-2 text-sm text-blue-100/80 hover:text-white transition-all duration-200">
                <span class="relative">
                  Stadion
                  <span class="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-white group-hover:w-full transition-all duration-300"></span>
                </span>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-3">
            <li class="group flex items-start gap-3">
              ...
              <a href="mailto:{{ email }}" class="text-sm text-blue-100/80 hover:text-white transition-colors duration-200 break-all hover:underline underline-offset-2">{{ email }}</a>
            </li>
            <li class="group flex items-start gap-3">
              ...
              <a :href="whatsappUrl" target="_blank" rel="noopener noreferrer" class="text-sm text-blue-100/80 hover:text-white transition-colors duration-200 hover:underline underline-offset-2">{{ nohp }}</a>
            </li>
            <li class="group flex items-start gap-3">
              <svg class="h-5 w-5 text-blue-300 flex-shrink-0 mt-0.5 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              ...
              <a href="https://maps.google.com/?q=Universitas+Diponegoro+Tembalang+Semarang" target="_blank" rel="noopener noreferrer" class="text-sm text-blue-100/80 hover:text-white transition-colors duration-200 hover:underline underline-offset-2">{{ address }}</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          <a href="https://undip.ac.id" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="Website Resmi UNDIP">
            <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
            </svg>
          </a>
          <a href="https://www.facebook.com/undip.official" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="Facebook">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
          </a>
          <a href="https://www.instagram.com/undip.official" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="Instagram">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://x.com/undip" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="X (Twitter)">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="https://www.tiktok.com/@undip.official" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="TikTok">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
            </svg>
          </a>
          <a href="http://www.youtube.com/@UndipTV" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="YouTube">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/school/diponegoro-university-indonesia" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-110 hover:-translate-y-1" title="LinkedIn">
            <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">

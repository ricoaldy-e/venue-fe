...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "date-picker-wrapper" }, _attrs))} data-v-f5a09cf6><button class="inline-flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold transition-all border bg-white text-gray-700 border-gray-200 hover:bg-gray-50 hover:border-gray-300 shadow-sm active:scale-95" data-v-f5a09cf6><svg class="w-4 h-4 sm:w-4.5 sm:h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f5a09cf6><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-f5a09cf6></path></svg><span class="hidden sm:inline" data-v-f5a09cf6>Pilih Tanggal</span><span class="sm:hidden" data-v-f5a09cf6>Kalender</span></button>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (isOpen.value) {
          _push2(`<div style="${ssrRenderStyle(popoverStyles.value)}" class="fixed z-50 w-[280px] sm:w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden" data-v-f5a09cf6><div class="flex items-center justify-between px-4 py-3 bg-[#1f2a56] text-white" data-v-f5a09cf6><button class="p-1.5 rounded-lg hover:bg-white/10 transition-colors" data-v-f5a09cf6><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f5a09cf6><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-f5a09cf6></path></svg></button><span class="text-sm font-semibold" data-v-f5a09cf6>${ssrInterpolate(currentMonth.value)}</span><button class="p-1.5 rounded-lg hover:bg-white/10 transition-colors" data-v-f5a09cf6><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f5a09cf6><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-v-f5a09cf6></path></svg></button></div><div class="p-3 sm:p-4" data-v-f5a09cf6><div class="grid grid-cols-7 gap-1 mb-2" data-v-f5a09cf6><!--[-->`);
          ssrRenderList(["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"], (day) => {
            _push2(`<div class="text-center text-xs font-semibold text-gray-600 py-1" data-v-f5a09cf6>${ssrInterpolate(day)}</div>`);
          });
          _push2(`<!--]--></div><div class="grid grid-cols-7 gap-1" data-v-f5a09cf6><!--[-->`);
          ssrRenderList(calendarDays.value, (item, index) => {
            ...
            ], "aspect-square rounded-lg text-sm font-medium transition-all"])}" data-v-f5a09cf6>${ssrInterpolate(item.day)}</button>`);
          });
          _push2(`<!--]--></div></div></div>`);
        } else {
          _push2(`<!---->`);
      ...
      if (isOpen.value) {
        _push(`<div class="fixed inset-0 z-40" data-v-f5a09cf6></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-f5a09cf6"]]), { __name: "SmartDatePicker" });

export { __nuxt_component_1 as _, __nuxt_component_2 as a, parseBackendError as p };
//# sourceMappingURL=SmartDatePicker-DidFka1k.mjs.map

  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(error)) {
        ...
        ssrRenderList(unref(paginatedFacilities), (facility) => {
          _push(`<div class="bg-white rounded-xl border border-gray-300 p-4 shadow-sm [@media(hover:hover)]:hover:shadow-md transition-all duration-200"><div class="flex items-center gap-4"><div class="shrink-0 w-12 h-12 flex items-center justify-center rounded-xl bg-blue-50 border border-blue-100 text-blue-600">`);
          if (facility.icon) {
            _push(ssrRenderComponent(unref(Icon), {
              icon: facility.icon,
              class: "h-6 w-6"
...
//# sourceMappingURL=index-CmlF8Mr7.mjs.map

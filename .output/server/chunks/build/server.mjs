...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BW0iS5yq.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": "auth-admin" } },
    component: () => import('./index-D28h11QD.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
  ...
  },
  {
    ...
    component: () => import('./index-CWysdCtw.mjs')
  },
  {
...
const namedMiddleware = {
  "auth-admin": () => import('./auth-admin-CWpMOIF5.mjs')
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-C4Q0DZEZ.mjs').then((m) => m.default || m)),

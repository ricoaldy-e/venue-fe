...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!sptjmFile.value) {
        _push(`<div class="mt-1"><label class="flex items-center justify-center w-full rounded-xl border-2 border-dashed border-gray-300 px-3 py-4 cursor-pointer hover:border-[#1f2a56] hover:bg-gray-50 transition-colors"><div class="flex flex-col items-center"><svg class="w-8 h-8 text-gray-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg><span class="text-sm text-gray-600">Klik untuk upload PDF</span></div><input type="file" accept=".pdf" class="hidden"></label></div>`);
      } else {
...
//# sourceMappingURL=order-O3UG3wzm.mjs.map

...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "date-picker-wrapper" }, _attrs))} data-v-2bc76e6b><button class="inline-flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold transition-all border bg-white text-gray-700 border-gray-200 hover:bg-gray-50 hover:border-gray-300 shadow-sm active:scale-95" data-v-2bc76e6b><svg class="w-4 h-4 sm:w-4.5 sm:h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2bc76e6b><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-2bc76e6b></path></svg><span class="hidden sm:inline" data-v-2bc76e6b>Pilih Tanggal</span><span class="sm:hidden" data-v-2bc76e6b>Kalender</span></button>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (isOpen.value) {
          _push2(`<div style="${ssrRenderStyle(popoverStyles.value)}" class="fixed z-50 w-[280px] sm:w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden" data-v-2bc76e6b><div class="flex items-center justify-between px-4 py-3 bg-[#1f2a56] text-white" data-v-2bc76e6b><button class="p-1.5 rounded-lg hover:bg-white/10 transition-colors" data-v-2bc76e6b><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2bc76e6b><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-2bc76e6b></path></svg></button><span class="text-sm font-semibold" data-v-2bc76e6b>${ssrInterpolate(currentMonth.value)}</span><button class="p-1.5 rounded-lg hover:bg-white/10 transition-colors" data-v-2bc76e6b><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2bc76e6b><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-v-2bc76e6b></path></svg></button></div><div class="p-3 sm:p-4" data-v-2bc76e6b><div class="grid grid-cols-7 gap-1 mb-2" data-v-2bc76e6b><!--[-->`);
          ssrRenderList(["Min", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"], (day) => {
            _push2(`<div class="text-center text-xs font-semibold text-gray-600 py-1" data-v-2bc76e6b>${ssrInterpolate(day)}</div>`);
          });
          _push2(`<!--]--></div><div class="grid grid-cols-7 gap-1" data-v-2bc76e6b><!--[-->`);
          ssrRenderList(calendarDays.value, (item, index) => {
            ...
            ], "aspect-square rounded-lg text-sm font-medium transition-all"])}" data-v-2bc76e6b>${ssrInterpolate(item.day)}</button>`);
          });
          _push2(`<!--]--></div></div></div>`);
        } else {
          _push2(`<!---->`);
      ...
      if (isOpen.value) {
        _push(`<div class="fixed inset-0 z-40" data-v-2bc76e6b></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-2bc76e6b"]]), { __name: "SmartDatePicker" });

export { __nuxt_component_1 as _, __nuxt_component_2 as a, parseBackendError as p };
//# sourceMappingURL=SmartDatePicker-BycLYZuX.mjs.map

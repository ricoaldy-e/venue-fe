...
import { defineComponent, computed, withAsyncContext, mergeProps, withCtx, createBlock, createVNode, openBlock, unref, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg><span${_scopeId}>Riwayat Booking</span>`);
          } else {
            return [
              ...
              createVNode("span", null, "Riwayat Booking")
            ];
          }
        }),
        _: 1
      ...
      if (unref(error)) {
        _push(`<div class="rounded-xl border border-red-200 bg-red-50 p-6 text-center text-red-700"><p class="font-semibold text-sm">Gagal memuat data venue.</p><button class="mt-2 underline font-bold [@media(hover:hover)]:hover:text-red-800 active:text-red-800">Coba lagi</button></div>`);
...
//# sourceMappingURL=index-Bc0Tt4YI.mjs.map

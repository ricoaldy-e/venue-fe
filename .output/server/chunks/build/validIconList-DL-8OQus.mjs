...
const VALID_FACILITY_ICONS = availableIcons.map(
  (i) => i.value
);
const availableIconsWithId = availableIcons.map((icon, idx) => ({
  id: `icon-${String(idx + 1).padStart(3, "0")}`,
  ...icon
}));

export { VALID_FACILITY_ICONS as V, availableIconsWithId as a };
//# sourceMappingURL=validIconList-DL-8OQus.mjs.map

...
useHead({
  title: 'Kebijakan Privasi - VENUE UNDIP',
  meta: [
      ...
      <div class="space-y-6">
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Informasi yang Kami Kumpulkan</h2>
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Bagaimana Kami Menggunakan Informasi Anda</h2>
              <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Perlindungan Data</h2>
              <p class="text-gray-600 leading-relaxed mb-4">
                Kami berkomitmen untuk melindungi data pribadi Anda dengan menerapkan langkah-langkah keamanan yang sesuai:
              </p>
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Berbagi Informasi dengan Pihak Ketiga</h2>
              <p class="text-gray-600 leading-relaxed mb-4">
                Kami <span class="font-semibold text-gray-900">tidak menjual, menyewakan, atau membagikan</span> informasi pribadi Anda kepada pihak ketiga untuk tujuan pemasaran. Kami hanya membagikan informasi dalam kondisi berikut:
              </p>
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Hak Anda</h2>
              <p class="text-gray-600 leading-relaxed mb-4">
                Anda memiliki hak atas data pribadi Anda:
              </p>
              <div class="space-y-3">
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Retensi Data</h2>
              <p class="text-gray-600 leading-relaxed mb-3">
                Kami menyimpan data pribadi Anda selama diperlukan untuk tujuan yang dijelaskan dalam kebijakan ini atau sesuai dengan ketentuan hukum yang berlaku.
              </p>
        ...
        <div class="rounded-2xl bg-white p-6 lg:p-8 shadow-lg shadow-gray-200/50 border border-gray-100/50">
          <div class="flex items-start gap-4 mb-4">
            ...
            <div class="flex-1">
              <h2 class="text-xl font-bold text-gray-900 mb-3">Perubahan Kebijakan Privasi</h2>
              <p class="text-gray-600 leading-relaxed mb-4">
              ...
              <p class="text-gray-600 leading-relaxed">
                Perubahan signifikan akan diberitahukan melalui email atau pemberitahuan di platform. Kami mendorong Anda untuk meninjau kebijakan ini secara berkala. Penggunaan berkelanjutan layanan kami setelah perubahan berarti Anda menerima kebijakan yang diperbarui.
              </p>
            </div>
          </div>
        </div>

...
const FALLBACK_OPTIONS = {
  name: "VENUE UNDIP",
  description:
    "Platform booking lapangan olahraga terpercaya untuk Sivitas Akademika Universitas Diponegoro.",
      ...
      <div class="flex items-start gap-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">
            Atur Option untuk informasi dasar VENUE UNDIP yang akan ditampilkan
            pada halaman publik.
          </p>
        </div>
      </div>
    ...
    >
      ...
      <div v-else-if="!editing" class="p-6 sm:p-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            class="p-5 rounded-xl bg-gray-100 border border-gray-200 flex items-center gap-4"
          >
            <div
        ...
        <div
          class="mt-6 flex items-start gap-3 p-4 rounded-lg bg-blue-50 border border-blue-100 text-blue-700 text-sm"
        >
          <svg
          ...
          <p>
            ...
            ditampilkan pada halaman publik {{ options?.name }}.
          </p>
        </div>
      </div>
      ...
      <div v-else class="p-6 sm:p-8 bg-gray-50/30">
        <div class="max-w-3xl mx-auto">
          ...
          >
            <div>
              ...
              <p class="text-xs text-gray-500 mt-1">
                Sesuaikan informasi dasar {{ options?.name }} yang akan ditampilkan pada halaman publik
              </p>
            </div>
            <button
          ...
          <div
            class="mb-6 flex items-start gap-3 p-4 rounded-lg bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm"
          >
            <svg
              class="w-5 h-5 shrink-0 mt-0.5 text-yellow-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <form
            ...
            class="space-y-6 bg-white p-8 rounded-2xl border border-gray-300 shadow-md ring-1 ring-black/5"
          >
              ...
              <div class="space-y-2">
                ...
                <div class="relative group">
                  ...
                  <input
                    ...
                    type="text"
                    class="block w-full rounded-xl border border-gray-300 bg-white py-3 pl-10 pr-4 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-all hover:border-gray-400"
                    placeholder="Masukkan no. WA (diawali dengan 62)"
                    required
                    :disabled="submitting"
                  >
                  <div
            ...
            <div
              v-if="submitError"
              class="p-3 rounded-lg bg-red-50 border border-red-100 text-red-600 text-sm font-medium flex items-center gap-2 animate-pulse"
            >
              <svg
